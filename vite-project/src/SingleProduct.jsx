            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                  <div className="flex">
                    <span className="mr-3">{product?.colors}</span>
                ...
                <div className="flex">
                  ...
                  <button className="flex ml-auto text-white bg-blue-500 border-[1px] border-blue-500 py-2 px-6 focus:outline-none hover:bg-transparent hover:text-black rounded text-lg duration-300">
                    Order
                  </button>
