      ...
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <form
              autoComplete="off"
              action="https://formspree.io/f/mrgnyooz"
              method="POST">
              ...
              <button className=" text-white bg-blue-500 border-[1px] border-blue-500 py-2 px-6 focus:outline-none hover:bg-transparent hover:text-black rounded text-lg duration-300 w-full">
                SUBMIT
              </button>
